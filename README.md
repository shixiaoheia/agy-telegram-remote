...
>
> **使用声明**
> - 本项目是社区维护的个人远程工具，与 Google、Telegram 没有官方关联。
> - 请仅在你拥有或已获明确授权的服务器、Bot 和工作目录中使用。
> - Bot Token、Google 登录凭据与工作目录内容由使用者自行保管；请勿提交到公开仓库或发送给他人。
> - agy 可能读取、修改文件或执行命令。启用前请确认白名单、专用账户和工作目录隔离已正确配置。
>
