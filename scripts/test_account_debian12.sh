...
[[ "$user_all_groups" == "$APP_USER" ]] || fail "Expected only $APP_USER group, got: $user_all_groups"
echo "PASS: New service account created with UID $user_uid, home $user_home, only own group: $user_all_groups."
